            ...
            <div>
              ...
              {step === 2 && (
                <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mt-0.5">
                  Step 2 of 2: Registration Details
                </p>
              )}
            </div>
          </div>
            ...
            <div className="space-y-6">
              <div className="text-center space-y-2 mb-4">
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  Choose the appropriate role to generate the correct workspace.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      For academic enrollment & clearance
                    </p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      For administrators & departmental heads
                    </p>
                  </div>
                </button>
              </div>
